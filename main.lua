...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      ...
      Subtitle = "Key System",
      Note = "If you will leak a password or script, I will change the link.",
      FileName = "Code",
      SaveKey = true,
...
Rayfield:Notify({
   ...
   Actions = {
      Ignore = {
         Name = "OK",
         Callback = function()
            print("Don't worry, just testing!")
         end
      }
   },
})
...
local Button = Tab:CreateButton({
   ...
   Callback = function()
      ...
      Rayfield:Notify({
         Title = "WARNING!",
         Content = "Leaderboard will disappear then! It's normal! Code doing this!",
         Duration = 6.5,
         Image = 4483362458,
         Actions = {
            Ignore = {
